...
public class TP_225150200111029_IdhamMuhamadAkbar_1 {
    ...
    public static int cariMatpel(String matpel){
        ...
        for (int i =0; i<banyakSiswaMatpel;i++){
            if (matpel.equals(siswaMatpel[0][0][i])) kodematpel = i;
        }
        return kodematpel;
    }
    /*
        ...
        if (index_siswa > -1) {
            ...
            for (int h =0;h<MAX_SEMESTER;h++){
                ...
                for (int i = 0; i < banyakSiswaMatpel; i++) {
                    ...
                    System.out.printf("%-20s| %9.1f| %14s\n", siswaMatpel[0][h][i], siswaMatpelNilai[index_siswa][0][i], nilai_huruf);
                }
            }
            System.out.println("\n>> END RAPORT <<");
        }
